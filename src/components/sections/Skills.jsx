  ...
  return (
    <section id="skills" className="py-28 md:py-36 border-t border-[#EAEAEA] ">
      <Container>
        ...
        <div className="rounded-lg  grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-[#EAEAEA] mt-16 border border-[#EAEAEA]">
          {CATEGORIES.map((cat, i) => (
            <Reveal key={cat.title} delay={i * 0.08} className="rounded-lg  bg-white p-8 flex flex-col gap-5">
