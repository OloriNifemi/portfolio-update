...
const RAW_PROJECTS = [
  ...
  },
  {
    ...
    image: WeddingWeb,
    desc: "Elegant wedding website with RSVP, countdown, gallery, and a live gift registry.",
  ...
  },
  {
    title: "Birthday Card",
    image: Birthday,
    desc: "An interactive animated birthday card built as a shareable web page.",
